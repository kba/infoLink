...
BASE=$PWD
PYTHON_SRC="$BASE/src/main/python"
JAVA_CLASSPATH="$BASE/build/classes/main"
echo $PYTHON_SRC
...
python $PYTHON_SRC/infoLink.py \
    ...
    -u \
    $PYTHON_SRC
# # learn patterns and apply patterns without text extraction. Use
# uppercase_constraint 
# python.exe # ../py/infoLink.py "."  #
# -c "../data/test/small_txt" 
# -l "../data/test/train_small/" # -s
# "\"ALLBUS Allbus Eurobarometer ISSP\"" 
# -i "../data/test/Index_small"

# -o "../data/test/output_small" # -m "../data/test/urnDict.csv" # -u
